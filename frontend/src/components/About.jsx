...
const About = () => {
    return (
        <section className="bg-white py-16 px-6 sm:px-12 md:px-24  text-center" id="about">
            <h2 className="text-4xl font-extrabold text-gray-800 mb-6">About StegoShield</h2>
            <p className="text-gray-600 max-w-4xl mx-auto mb-10 text-lg text-justify">
            ...
            <div className="mt-12">
                <h3 className="text-3xl font-bold text-gray-800 mb-4">Meet the Developer</h3>
                <div className="max-w-3xl mx-auto bg-gray-50 rounded-xl p-6 shadow-md">
